...
| next_drone_type_changed | player_id, next_drone_type |
...
| next_drone_type_changed | next_drone_type | next_drone_type_changed => game |
...
| eval_drones | tick_count | move_ended \| died => all drones; field_state_changed => game | |
